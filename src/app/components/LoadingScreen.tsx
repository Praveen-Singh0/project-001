    ...
    <AnimatePresence>
      {phase !== "out" ? (
        <motion.div
          ...
          style={{
            background: "radial-gradient(ellipse 120% 80% at 50% 0%, rgba(58,229,178,0.08) 0%, transparent 55%), radial-gradient(ellipse 80% 60% at 80% 60%, rgba(108,99,255,0.07) 0%, transparent 55%), #04050d",
          }}
        >
          {/* Animated ring */}
          <div className="relative flex items-center justify-center mb-8">
            <motion.div
              ...
              style={{ width: 100, height: 100, border: "1px solid rgba(58,229,178,0.2)" }}
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow: "0 0 40px rgba(58,229,178,0.4), 0 0 80px rgba(108,99,255,0.2)",
              }}
            >
              <span
              ...
              >
                <span
                  style={{
                    ...
                    background: "linear-gradient(135deg, #f0f4ff 0%, rgba(58,229,178,0.8) 50%, #6C63FF 100%)",
