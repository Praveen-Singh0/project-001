...
const testimonials = [
  {
    ...
    avatarColor: "#00E5FF",
    quote:
      "DTECHEX didn't just build us a system — they reimagined how our 12 hospitals operated. The AI triage engine alone has saved hundreds of clinical hours per week. Exceptional technical depth and the most rigorous delivery process I've worked with in 15 years.",
    rating: 5,
  },
  {
    name: "James Okonkwo",
    ...
    avatarColor: "#6C63FF",
    quote:
      "Our FinTech analytics platform went from a fragile legacy system to a sub-50ms real-time engine in six months. DTECHEX's team has a rare combination: they understand finance deeply and they ship production-quality AI. We've renewed our retainer twice.",
    rating: 5,
  },
  {
    ...
    avatarColor: "#00BFFF",
    quote:
      "The personalization engine DTECHEX built added $4M in incremental revenue in the first year. What impressed me most was how they collaborated with our team — they upskilled our engineers, not just replaced them. True partners.",
    rating: 5,
  },
  {
    name: "Daniel Ferrara",
    ...
    avatarColor: "#a78bfa",
    quote:
      "We tried two other vendors before DTECHEX. They were the only team that could handle the complexity of our supply chain data model while also delivering a UI our warehouse staff could actually use. Delivery was on time, on budget, and beyond scope.",
    rating: 5,
  },
  {
    name: "Aiko Tanaka",
    ...
    avatarColor: "#f472b6",
    quote:
      "DTECHEX built our adaptive learning platform from zero to 50,000 students in eight months. The AI content recommendation system is genuinely impressive — engagement metrics are up 41% over our previous platform.",
    rating: 5,
  },
];
            ...
            >
              ...
              <div className="flex gap-1">
                {Array.from({ length: t.rating }).map((_, i) => (
                  <div key={i} style={{ color: "#fbbf24", fontSize: 16 }}>
                    ★
                  </div>
                ))}
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div style={{ fontWeight: 600, color: fg, fontSize: 15 }}>
                    {t.name}
                  </div>
          ...
          <div className="flex items-center justify-between mt-8">
            ...
            <div className="flex gap-3">
              <button
                ...
                style={{
                  border: `1px solid ${isDark ? "rgba(255,255,255,0.1)" : "rgba(108,99,255,0.1)"}`,
                  color: muted,
                }}
                onMouseEnter={(e) => {
