    ...
    <div className="relative w-64 h-64 mx-auto">
      ...
      {[
        ...
        <motion.div
          ...
          style={{ ...dot, background: dot.color, boxShadow: `0 0 8px ${dot.color}`, marginLeft: -6, marginTop: -6 }}
...
export function AuthLayout({ children, tagline = "The intelligent enterprise platform for tomorrow's leaders." }: AuthLayoutProps) {
    ...
    >
      ...
      >
        ...
        <div className="relative z-10">
          ...
          >
            ...
            <span style={{ fontWeight: 800, fontSize: 16, color: "#f0f4ff", letterSpacing: "-0.02em" }}>DTECHEX</span>
          </button>
        </div>
        ...
        <div className="relative z-10 flex flex-col items-center gap-8">
          ...
          <div className="text-center">
            <p style={{ fontSize: 18, fontWeight: 700, color: "#f0f4ff", lineHeight: 1.4, letterSpacing: "-0.01em" }}>{tagline}</p>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 md:p-12 relative overflow-hidden">
        ...
        <button
          ...
          onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.color = isDark ? "#f0f4ff" : "#0d0f1e"; }}
          onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.color = isDark ? "#8892b0" : "#6271a0"; }}
        >
          <ArrowLeft size={14} />
          Back to site
        </button>
