...
import { Cloud, Server, Zap, Database, Lock, CheckCircle } from "lucide-react";
...
export function CloudServicesPage() {
  ...
  return (
    <main style={{ background: bg }}>
      ...
      <section className="min-h-[70vh] flex items-center justify-center py-20 px-6">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <button
              style={{
                background: `linear-gradient(105deg, #259f80ff, #25999fff`,
                color: "#fff",
                border: "none",
                padding: "14px 32px",
                borderRadius: "50px",
      ...
      {/* Features Grid */}
      <section className=" px-6" style={{ background: isDark ? "rgba(255,255,255,0.01)" : "rgba(255,255,255,0.3)" }}>
